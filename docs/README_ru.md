...
Вы можете создать собственный эффект, если умеете писать glsl плагины и немного разбираетесь в C++.
Ваш проект может быть собран как динамическая библиотека .so

Подробно читайте в (этом разделе)[PLUGIN_DEV_GUIDE_ru.md]
